package com.sgq.Spring.aop.bean4;
...
public class test4 {
    ...
    public static void main(String[] args){
        ...
        //这里是一般的Java项目，所以使用下面的方式
                ApplicationContext appCtx = new FileSystemXmlApplicationContext("E:\\spring-boot\\springboot\\test-test\\src\\main\\java\\com\\sgq\\Spring\\aop\\bean4\\spring.xml");
